...
class IndividualInfo(BaseModel):
    ...
    bank_account_bank_name: Optional[str]  # nome do banco da conta bancária  | TED/DOC apenas
    bank_account_bank_code: Optional[constr(min_length=3, max_length=3)]  # código do banco da conta bancária  | TED/DOC apenas
    bank_account_number: Optional[str]  # número da conta bancária  | TED/DOC apenas
    bank_account_number_dv: Optional[str]  # dv do númerp da conta bancária  | TED/DOC apenas
    bank_account_routing: Optional[str]  # agência da conta bancária  | TED/DOC apenas
    bank_account_routing_dv: Optional[str]  # dv da agência da conta bancária  | TED/DOC apenas
...
class TransactionModel(IndividualInfo, BaseModel):
    """ HEADER DO LOTE """
    payment_type:  Literal["01", "03", "41", "43", "30", "31"]  # código do tipo de pagamento
    ...
    expiration_date: Optional[str]  # data do vencimento (formato DDMMAAAA)  | boleto apenas
